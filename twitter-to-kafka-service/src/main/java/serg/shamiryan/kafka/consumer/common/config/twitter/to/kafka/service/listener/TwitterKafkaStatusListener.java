package serg.shamiryan.kafka.consumer.common.config.twitter.to.kafka.service.listener;

import com.microservices.demo.kafka.avro.model.TwitterAvroModel;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Component;
import serg.shamiryan.kafka.consumer.common.config.twitter.to.kafka.service.transformer.TwitterStatusToAvroTransformer;
import serg.shamiryan.kafka.consumer.config.KafkaConfigData;
import serg.shamiryan.kafka.consumer.kafka.producer.service.TwitterKafkaProducer;
