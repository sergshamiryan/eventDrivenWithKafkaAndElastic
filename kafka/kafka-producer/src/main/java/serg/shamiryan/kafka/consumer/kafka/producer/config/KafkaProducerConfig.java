package serg.shamiryan.kafka.consumer.kafka.producer.config;
...
import serg.shamiryan.kafka.consumer.config.KafkaProducerConfigData;
...
/*SpecificRecordBase class from avro Library*/
